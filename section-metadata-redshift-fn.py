...
def build_sections(records):
    ...
    for record in records:
        ...
        section_name = parse_value(record[1])
        attribute_id = parse_value(record[2])
        attribute_name = parse_value(record[3])
        attribute_type = parse_value(record[4])
        attribute_options = parse_value(record[5])
        ...
        sections[section_id]["attributes"].append({
